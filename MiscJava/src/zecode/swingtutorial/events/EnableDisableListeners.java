package zecode.swingtutorial.events;
...
public class EnableDisableListeners extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                EnableDisableListeners ex = new EnableDisableListeners();
                ex.setVisible(true);
            }
        });
    }
