package heinz.newsletter18_ClassNamesDontIdentifyClass;
...
public static void main(String[] args) throws Exception {
  ClassLoader parent = new URLClassLoader(
	new URL[] {new URL("file:heinz.newsletter18./")}, null);
  ClassLoader a1 = new URLClassLoader(
	new URL[] {new URL("file:heinz.newsletter18/a1/")}, parent);
  ClassLoader a2 = new URLClassLoader(
	new URL[] {new URL("file:heinz.newsletter18/a2/")}, parent);
