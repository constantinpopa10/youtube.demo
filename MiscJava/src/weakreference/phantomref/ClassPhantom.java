package weakreference.phantomref;
...
public class ClassPhantom {
	...
	public static void main(String args[]) throws InterruptedException {
		...
		System.out.println("Our phantom refence before gc: " + phantom.get());
		...
		System.out.println("The object phantomReference references: " + phantom.get());
		if (reference != null) {
