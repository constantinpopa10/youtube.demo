...
import coursera_algorithms.allClasses.alg4.Queue;
import coursera_algorithms.allClasses.alg4.Stack;
...
public class BreadthFirstPaths {
    ...
    public static void main(String[] args) {
    	String fileName = MiscUtils.ALGORITHMS_SAMPLE_DATA + "tinyCG.txt";
    	String node = "0";
